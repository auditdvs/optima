...
function Login() {
  ...
  useEffect(() => {
    if (user) {
      ...
      // Show welcome toast with tutorial hint
      setTimeout(() => {
        toast.custom(
          (t) => (
            <div
              className={`
                bg-white dark:bg-gray-800 border-l-4 border-red-500 rounded-lg shadow-lg p-4 max-w-sm
            ...
            >
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0">
                  <div className="w-8 h-8 bg-blue-100 dark:bg-yellow-900 rounded-full flex items-center justify-center">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                    Taukah anda, menu tutorial bisa membantu kebingungan anda terkait OPTIMA :)
                  </p>
                </div>
              </div>
            </div>
      ...
      }, 1000); // Delay 1 detik setelah navigasi
    }
