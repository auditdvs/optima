...
function AuditRatingCalculator() {
  ...
  const calculateRating = () => {
    ...
    // Logic berdasarkan tabel kriteria sesuai yang sudah ada
    if (major >= 3) {
      setRating("HIGH");
    } else if (major === 2) {
      if (moderate > 10) {
            ...
            <div className="space-y-4 mt-2 relative z-10 max-h-[60vh] overflow-y-auto">
              <div className="p-3 bg-green-50 border border-green-200 rounded-md">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700">
                  <li>Tidak ada issue/temuan kategori MAJOR/HIGH, ATAU</li>
                  <li>Ada 1 s.d. 7 issue/temuan kategori MODERATE/MEDIUM</li>
                </ul>
              </div>
              ...
              <div className="p-3 bg-amber-50 border border-amber-200 rounded-md">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700">
                  <li>Tidak ada issue/temuan kategori MAJOR/HIGH dan terdapat 8 s.d. 15 issue/temuan kategori MODERATE/MEDIUM, ATAU</li>
                  <li>Terdapat 1 issue/temuan kategori MAJOR/HIGH dan terdapat 8 s.d. 12 issue/temuan kategori MODERATE/MEDIUM, ATAU</li>
                  <li>Terdapat 2 issue/temuan kategori MAJOR/HIGH dan terdapat 8 s.d. 10 issue/temuan kategori MODERATE/MEDIUM</li>
                </ul>
              </div>
              ...
              <div className="p-3 bg-red-50 border border-red-200 rounded-md">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700">
                  <li>Terdapat 1 s.d. 2 issue/temuan kategori MAJOR/HIGH dan lebih dari 12 issue/temuan kategori MODERATE/MEDIUM, ATAU</li>
                  <li>Terdapat lebih dari 3 issue/temuan kategori MAJOR/HIGH, ATAU</li>
                  <li>Terdapat FRAUD</li>
                </ul>
              </div>
