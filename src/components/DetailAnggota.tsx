      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title="Refresh SRSS data"
            disabled={loadingSrss}
          >
            <RefreshCw size={18} className={`text-gray-500 ${loadingSrss ? 'animate-spin' : ''}`} />
          </button>
        </div>
                      ...
                      <div className="flex gap-2">
                        {request.result_path && (
                          <button
                            ...
                            title="Download file"
                            onClick={() => handleCustomDownload(request.result_path, `Detail Anggota-${request.branch_code}.csv`)}
                          >
