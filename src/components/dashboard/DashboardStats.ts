            ...
            <div className="flex-1 pt-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-blue-600">{stats.annualAudits} Annual</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <CardContent className="p-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 pt-4">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-semibold">Rp {stats.totalFraud.toLocaleString('id-ID')}</span>
                <span className="text-xs text-gray-500">{stats.totalFraudCases} cases detected</span>
              </div>
            </div>
          </div>
        </CardContent>
